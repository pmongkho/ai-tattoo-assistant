...
namespace dotnet_server.Migrations
{
    ...
    [Migration("20250812205202_AddConsultationContactFields")]
    partial class AddConsultationContactFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNet.Models.ApplicationUser", b =>
                {
                    ...
                    b.ToTable("AspNetUsers", null, t =>
                        {
                            t.HasCheckConstraint("CK_Users_UserRole", "\"UserRole\" IN ('artist', 'client')");
                        });
                });
            ...
            modelBuilder.Entity("DotNet.Models.ArtistProfile", b =>
                {
            ...
            modelBuilder.Entity("DotNet.Models.Consultation", b =>
                {
                    ...
                    b.Property<string>("PriceExpectation")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("Consultations", t =>
                        {
                            t.HasCheckConstraint("CK_Consultations_Status", "\"Status\" IN ('pending', 'approved', 'rejected')");
                        });
                });
            ...
            modelBuilder.Entity("DotNet.Models.TattooJob", b =>
                {
                    ...
                    b.ToTable("TattooJobs", t =>
                        {
                            t.HasCheckConstraint("CK_TattooJobs_Type", "\"Type\" IN ('client_request', 'artist_offer')");
                        });
                });
            ...
            modelBuilder.Entity("DotNet.Models.UserImage", b =>
                {
                    ...
                    b.ToTable("UserImages", t =>
                        {
                            t.HasCheckConstraint("CK_UserImages_ImageType", "\"ImageType\" IN ('Profile', 'Reference', 'Placement', 'Portfolio')");
                        });
                });
            ...
            modelBuilder.Entity("DotNet.Models.ArtistProfile", b =>
                {
                    b.HasOne("DotNet.Models.ApplicationUser", "User")
                        .WithOne("ArtistProfile")
                        .HasForeignKey("DotNet.Models.ArtistProfile", "UserId")
            ...
            modelBuilder.Entity("DotNet.Models.ApplicationUser", b =>
                {
                    b.Navigation("ArtistAppointments");

                    b.Navigation("ArtistConsultations");

                    b.Navigation("ArtistProfile");

                    b.Navigation("ClientAppointments");

                    b.Navigation("ClientConsultations");
